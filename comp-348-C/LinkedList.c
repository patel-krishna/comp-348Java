...
// that returns tail of the list, represented by e.
// The tail of a list with one or zero element is NIL. The tail of an element that is not a list is also NIL.
list cdr(element e)
{
